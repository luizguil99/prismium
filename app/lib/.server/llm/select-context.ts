...
---
    ...
    prompt: `
        ...
        * If the project uses shadcn-ui, DO NOT include shadcn component files in the context buffer as you already know their content and functionality. Only include shadcn components if it's ABSOLUTELY CRITICAL for understanding custom modifications or specific implementations.
  ...
  if (totalFiles == 0) {
    throw new Error(`Prismium failed to select files`);
  }
