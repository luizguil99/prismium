...
interface CloudflareSvgLogoProps {
  width?: number;
  height?: number;
  color?: string;
}

export default function CloudflareSvgLogo({ width = 24, height = 24, color = '#F6821F' }: CloudflareSvgLogoProps) {
  return (
    <svg width={width} height={height} viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g>
        <path d="M190.4,128.5c1.4-4.9,1-9.7-1.2-12.6c-2.4-2.9-6-4.9-10.3-5.4L70.1,108.6c-0.5,0-1-0.5-1.5-0.5c-0.5-0.5-0.5-1,0-1.5c0.5-1,1-1.5,2-1.5l93,0.9c10.3-0.5,22-9.2,26-19.5l5-13.6c0-0.5,0.5-1,0-1.5c-5.4-25-28.4-43.7-55.1-43.7c-24.5,0-45.7,15.6-53.2,38c-4.9-3.4-10.8-5.4-17.6-4.9c-11.7,1-21.1,11.2-22.5,23.5c-0.5,2.9,0,5.8,0.5,8.8c-19.1,0.5-34.7,16.6-34.7,36.7c0,2,0,3.4,0.5,5.4c0,1,1,1.5,1.5,1.5h157.9c1,0,2-0.5,2-1.5L190.4,128.5z" fill={color}/>
