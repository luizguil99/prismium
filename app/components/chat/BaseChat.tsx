            ...
            <div className="flex flex-col justify-center gap-5">
              ...
              {!chatStarted && (
                <>
                  ...
                  <FeaturedTemplates handlePromptAndClone={handlePromptAndClone} />
                  ...
                  <div className="mt-16 max-w-3xl mx-auto">
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        ...
                        <div className="relative flex items-center gap-6 w-full">
                          <div className="flex-shrink-0 transform group-hover:scale-110 transition-transform duration-200">
                            <img src={logoReact} alt="React" className="w-8 h-8" />
                          </div>
                          <div>
                            ...
                            <p className="text-[#8B98A9] text-sm leading-relaxed group-hover:text-gray-300 transition-colors">
                              Crie um novo app React em TypeScript ou JavaScript usando Vite
                            </p>
                          </div>
                          <ChevronRight
                            size={16}
                      ...
                      >
                        ...
                        <div className="relative flex items-center gap-6 w-full">
                          <div className="flex-shrink-0 transform group-hover:scale-110 transition-transform duration-200">
                            <img src={logoNextjs} alt="NextJS" className="w-8 h-8" />
                          </div>
                          <div>
                            <h3 className="text-[#D9DFE7] font-['Segoe UI'] text-lg font-semibold leading-tight mb-1 group-hover:text-blue-400 transition-colors">
                              Next.js
                            ...
                            <p className="text-[#8B98A9] text-sm leading-relaxed group-hover:text-gray-300 transition-colors">
                              Crie um app full-stack NextJS com TypeScript ou JavaScript e renderização server-side
                            </p>
                          </div>
                          <ChevronRight
                            size={16}
                      ...
                      >
                        ...
                        <div className="relative flex items-center gap-6 w-full">
                          <div className="flex-shrink-0 transform group-hover:scale-110 transition-transform duration-200">
                            <img src={logoVue} alt="Vue" className="w-8 h-8" />
                          </div>
                          <div>
                            <h3 className="text-[#D9DFE7] font-['Segoe UI'] text-lg font-semibold leading-tight mb-1 group-hover:text-blue-400 transition-colors">
                              Vue
                            ...
                            <p className="text-[#8B98A9] text-sm leading-relaxed group-hover:text-gray-300 transition-colors">
                              Crie um novo app Vue em TypeScript ou JavaScript usando Vite
                            </p>
                          </div>
                          <ChevronRight
                            size={16}
                      ...
                      >
                        ...
                        <div className="relative flex items-center gap-6 w-full">
                          <div className="flex-shrink-0 transform group-hover:scale-110 transition-transform duration-200">
                            <img src={logoAngular} alt="Angular" className="w-8 h-8" />
                          </div>
                          <div>
                            <h3 className="text-[#D9DFE7] font-['Segoe UI'] text-lg font-semibold leading-tight mb-1 group-hover:text-blue-400 transition-colors">
                              Angular
                            ...
                            <p className="text-[#8B98A9] text-sm leading-relaxed group-hover:text-gray-300 transition-colors">
                              Crie um novo app Angular em TypeScript usando ng-cli
                            </p>
                          </div>
                          <ChevronRight
                            size={16}
                      ...
                      >
                        ...
                        <div className="relative flex items-center gap-6 w-full">
                          <div className="flex-shrink-0 transform group-hover:scale-110 transition-transform duration-200">
                            <img src={logoAstro} alt="Astro" className="w-8 h-8" />
                          </div>
                          <div>
                            <h3 className="text-[#D9DFE7] font-['Segoe UI'] text-lg font-semibold leading-tight mb-1 group-hover:text-blue-400 transition-colors">
                              Astro
                            ...
                            <p className="text-[#8B98A9] text-sm leading-relaxed group-hover:text-gray-300 transition-colors">
                              Crie um app web full-stack com Astro, um framework que oferece superpoderes focados em
                              conteúdo
                            </p>
                          </div>
                          <ChevronRight
